...
namespace libfreenect2
{
  namespace usb
  {
    ...
    TransferPool::TransferPool(libusb_device_handle *device_handle, unsigned char device_endpoint) : callback_(0),
    ...
    BulkTransferPool::BulkTransferPool(libusb_device_handle *device_handle, unsigned char device_endpoint) : TransferPool(device_handle, device_endpoint)
    {
    }
    ...
    IsoTransferPool::IsoTransferPool(libusb_device_handle *device_handle, unsigned char device_endpoint) : TransferPool(device_handle, device_endpoint),
                                                                                                           num_packets_(0),
                                                                                                           packet_size_(0)
    {
    }
