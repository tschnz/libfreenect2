...
namespace libfreenect2
{
  ...
  Frame::Frame(size_t width, size_t height, size_t bytes_per_pixel, unsigned char *data_) : width(width),
                                                                                            height(height),
  ...
  public:
    ...
    SyncMultiFrameListenerImpl(unsigned int frame_types) : subscribed_frame_types_(frame_types),
  ...
  SyncMultiFrameListener::SyncMultiFrameListener(unsigned int frame_types) : impl_(new SyncMultiFrameListenerImpl(frame_types))
  {
  }
  ...
  {
    if ((impl_->subscribed_frame_types_ & type) == 0)
      return false;
