...
namespace libfreenect2
{
  ...
  {
  public:
    VTFrame(size_t width, size_t height, size_t bytes_per_pixel, CVPixelBufferRef pixelBuffer) : Frame(width,
                                                                                                       height,
                                                                                                       bytes_per_pixel,
  ...
  VTRgbPacketProcessor::VTRgbPacketProcessor()
      : RgbPacketProcessor(), impl_(new VTRgbPacketProcessorImpl())
  {
  }
