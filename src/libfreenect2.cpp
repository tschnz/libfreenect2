...
#include "processors/depth_packet_processor.h"
#include "processors/rgb_packet_processor.h"
...
namespace libfreenect2
{
  ...
  */
  struct IrCameraTables : Freenect2Device::IrCameraParams
  {
    ...
    IrCameraTables(const Freenect2Device::IrCameraParams &parent) : Freenect2Device::IrCameraParams(parent),
  ...
  public:
    ...
    Freenect2Impl(void *usb_context) : managed_usb_context_(usb_context == 0),
  ...
  Freenect2DeviceImpl::Freenect2DeviceImpl(Freenect2Impl *context, const PacketPipeline *pipeline, libusb_device *usb_device, libusb_device_handle *usb_device_handle, const std::string &serial) : state_(Created),
  ...
  Freenect2Device::Config::Config() : MinDepth(0.5f),
